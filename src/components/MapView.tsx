...
const MapView = () => {
  const [layers] = useState<Layer[]>([
    ...
    },
    {
      ...
      url: "http://localhost:8888/geoserver/wms?service=WMS&version=1.1.0&request=GetMap&layers=ward_boundaries&styles=&format=image/png&transparent=true",
      active: false,
    },
    {
      name: "water",
      displayName: "Sông nước",
      url: "http://localhost:8888/geoserver/wms?service=WMS&version=1.1.0&request=GetMap&layers=water&styles=&format=image/png&transparent=true",
      active: false,
    },
    {
      name: "waterways",
      displayName: "Đường thủy",
      url: "http://localhost:8888/geoserver/wms?service=WMS&version=1.1.0&request=GetMap&layers=waterways&styles=&format=image/png&transparent=true",
      active: false,
    },
    {
      name: "roads",
    ...
    {
      name: "cayxanh",
      displayName: "Cây xanh",
      url: "http://localhost:8888/geoserver/wms?service=WMS&version=1.1.0&request=GetMap&layers=cayxanh&styles=&format=image/png&transparent=true",
      active: false,
    },
  ]);
